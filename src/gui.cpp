...
void print_like_nvidia_smi(GPUInforPtrVector &gpuinfors)
{
    ...
    cout << line << endl;
    cout << "|" << setw(TABLE_WIDTH - 2) << left << "Driver Version: "
         << "|" << endl;
    cout << line << endl;
    ...
    for (int i = 0; i < gpuinfors.size(); i++)
    {
        ...
        cout << "|" << setw(COLUMN_1_WIDTH) << left << to_string(i)
             ...
             << setw(TABLE_WIDTH - COLUMN_1_WIDTH - COLUMN_4_WIDTH - 2) << left << " "
             << "|" << endl;
        cout << "|" << setw(COLUMN_1_WIDTH) << left << to_string(gpuinfor->fan_speed) + "%"
             ...
             << "|"
             << setw(COLUMN_2_WIDTH) << left << to_string(gpuinfor->utilization.gpu) + "%" << endl;
    }
